...
// void vTask1_S9(void* pvParameters);
// void vTaskDisplay_S9(void* pvParameters);
// void vTaskCalcRMS_vA_S9();
// void vTaskCalcRMS_vB_S9();
// void vTaskCalcRMS_vC_S9();

// //float CalcRMS_S9(float valueToConvert);
// float CalcRMS_S9(float *samplesArray);

// /* Handle para o MUTEX */
// SemaphoreHandle_t xMutex_vA = NULL;
// SemaphoreHandle_t xMutex_vB = NULL;
// SemaphoreHandle_t xMutex_vC = NULL;
...
// 	/*Cria o MUTEX*/
// 	xMutex_vA = xSemaphoreCreateRecursiveMutex();
// 	xMutex_vB = xSemaphoreCreateRecursiveMutex();
// 	xMutex_vC = xSemaphoreCreateRecursiveMutex();

// 	/*Cria o Semáforo Binário*/
// 	//vSemaphoreCreateBinary(xBinarySemaphore);

// 	/* Testa se o MUTEX foi criado corretamente */
// 	if ((xMutex_vA == NULL) || (xMutex_vB == NULL) || (xMutex_vC == NULL))
// 	//if (xBinarySemaphore == NULL)
// 	{
// 		printf_colored("---------------------------------------------------------------\r\n", COLOR_RED);
// 		printf_colored("> Ocorreu um erro ao criar o MUTEX!!\r\n", COLOR_RED);
...
// 		return 1;
// 	}
// 	xSemaphoreTakeRecursive(xMutex_vA, portMAX_DELAY);
// 	xSemaphoreTakeRecursive(xMutex_vB, portMAX_DELAY);
// 	xSemaphoreTakeRecursive(xMutex_vC, portMAX_DELAY);
// 	//xSemaphoreTake(xBinarySemaphore, portMAX_DELAY);
...
// 			//xSemaphoreGive(xBinarySemaphore);
// 			xSemaphoreGiveRecursive(xMutex_vA);
// 			//return;
// 		}
...
// 			//printf("\r\n\rTask RMS: FINAL GIVE \n\r\n");
// 			//xSemaphoreGive(xBinarySemaphore);
// 			xSemaphoreGiveRecursive(xMutex_vB);
// 			//return;
// 		}
// 		// -------------------------
// 		//printf_colored("Destinatário tenta ler mensagem na fila xQueue_vB.\n", COLOR_GREEN);
...
// 			//printf("\r\n\rTask RMS: FINAL GIVE \n\r\n");
// 			//xSemaphoreGive(xBinarySemaphore);
// 			xSemaphoreGiveRecursive(xMutex_vC);
// 			//return;
// 		}
...
// 	for (ui = 0; ui < N; ui++)
// 	{
// 		sumOfSquares += pow(samplesArray[ui], 2);
// 	}
// 	// fazer a média dos quadrados dos N itens lidos e tirar a raiz
// 	return sqrt(sumOfSquares/N);
// }